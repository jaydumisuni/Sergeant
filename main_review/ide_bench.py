...
The IDE layer does not run a different reviewer. VS Code, JetBrains, and AI tools
all hand off the same review request shape to the app bridge and receive the same
review response shape back.
"""
...
AI_HANDOFF_CONTRACT = {
    ...
    "request": {
        ...
        "external_providers": "optional reviewer evidence packets such as CodeRabbit comments",
