...
def test_cpl_schedules_only_unique_open_assurance_frontier():
    from main_review.cpl_campaign import schedule_assurance_frontier

    assert schedule_assurance_frontier(["obl-1", "", "obl-1", "obl-2"]) == ("obl-1", "obl-2")
