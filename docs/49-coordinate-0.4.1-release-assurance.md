...
Publication must occur from the exact `main` head after the 0.4.1 release-candidate PR has passed all required proof. A feature-branch head is not release authority.
