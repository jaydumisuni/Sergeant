...
Sergeant's primary benchmark mode is model-free. One-model and multi-model modes are optional comparisons that measure the extra reasoning an owner may enable. The canonical product boundary is documented in [`54-model-free-core-and-optional-reasoning.md`](54-model-free-core-and-optional-reasoning.md).
